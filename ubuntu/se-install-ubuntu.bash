...
do
    case $opt in
        ...
        wget -O vpnserver-init-bridge https://raw.githubusercontent.com/essoojay/softether-autoinstall/refs/heads/master/vpnserver-init-bridge > /dev/null 2>&1
        ...
        break
            ;;
        "No")
        wget -O vpnserver-init https://raw.githubusercontent.com/essoojay/softether-autoinstall/refs/heads/master/vpnserver-init > /dev/null 2>&1
